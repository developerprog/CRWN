    ...
    constructor() {
        ...
        this.state = {
            section: [
                {
                title: 'hats',
                imageUrl: 'https://partycity6.scene7.com/is/image/PartyCity/_pdp_sq_?$_1000x1000_$&$product=PartyCity/691727',
                id: 1,
                linkUrl: 'hats'
            },
            ...
            {
                title: 'sneakers',
                imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcThHk17kl2ch2C6eXeaZq51X1d-6KIl6IW3Aw&usqp=CAU',
                id: 3,
                linkUrl: ''
            },
            ...
            {
                title: 'womens',
                imageUrl: 'https://russiafashionweeklive.com/wp-content/uploads/2018/04/Womens-Fashion.jpg',
                id: 4,
                size: 'large',
                linkUrl: ''
            },
            ...
            {
                title: 'mens',
                imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRZpakQJ0jgdzAI3rmRL8HL1wFeXp3PTC16-Q&usqp=CAU',
                id: 5,
                size: 'large',
                linkUrl: ''
            }]
    ...
    render() {
        return (
            <div className='directory-menu'>
              {
                  this.state.section.map(({id, ...otherSectionProb }) => (
                      <MenuItem key={id} {...otherSectionProb}/>
                  ))
              }
            </div>
        );
